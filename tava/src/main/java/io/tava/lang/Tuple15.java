...
public class Tuple15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> {
	...
	public boolean equals(Object obj) {
		...
		if (!tuple15.getValue1().equals(this.getValue1())) {
			return false;
		}
		if (!tuple15.getValue2().equals(this.getValue2())) {
			return false;
		}
		if (!tuple15.getValue3().equals(this.getValue3())) {
			return false;
		}
		if (!tuple15.getValue4().equals(this.getValue4())) {
			return false;
		}
		if (!tuple15.getValue5().equals(this.getValue5())) {
			return false;
		}
		if (!tuple15.getValue6().equals(this.getValue6())) {
			return false;
		}
		if (!tuple15.getValue7().equals(this.getValue7())) {
			return false;
		}
		if (!tuple15.getValue8().equals(this.getValue8())) {
			return false;
		}
		if (!tuple15.getValue9().equals(this.getValue9())) {
			return false;
		}
		if (!tuple15.getValue10().equals(this.getValue10())) {
			return false;
		}
		if (!tuple15.getValue11().equals(this.getValue11())) {
			return false;
		}
		if (!tuple15.getValue12().equals(this.getValue12())) {
			return false;
		}
		if (!tuple15.getValue13().equals(this.getValue13())) {
			return false;
		}
		if (!tuple15.getValue14().equals(this.getValue14())) {
			return false;
		}
		return tuple15.getValue15().equals(this.getValue15());
	}
